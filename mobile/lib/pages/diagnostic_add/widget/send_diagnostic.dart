...
class SendDiagnostic extends StatelessWidget {
  const SendDiagnostic({super.key, required this.listuser});
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              diagnosticAddController.chosenuser.value != null
                  ? FollowingPersonBox(
                      avapath:
                          diagnosticAddController.chosenuser.value!.photourl!,
                      name: diagnosticAddController.chosenuser.value!.name!,
                      gender:
                          diagnosticAddController.chosenuser.value!.gender != ""
                              ? diagnosticAddController
                                  .chosenuser.value!.gender!
                              : "chưa cập nhật",
                      age: diagnosticAddController.chosenuser.value!.age != 0
                          ? diagnosticAddController.chosenuser.value!.age!
                              .toString()
                          : "chưa cập nhật",
                      person: "Bệnh nhân")
                  : SizedBox(
